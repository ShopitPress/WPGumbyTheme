        ...
        public function setSections() {
            ...
            <?php echo $this->theme->display('Name'); ?>
                ...
                if ($this->theme->parent()) {
                    printf(' <p class="howto">' . __('This <a href="%1$s">child theme</a> requires its parent theme, %2$s.') . '</p>', __('http://codex.wordpress.org/Child_Themes', 'wpgumby'), $this->theme->parent()->display('Name'));
                }
                ?>
                ...
                'fields' => array(
					...
					array(
                        ...
                        'options' => array(
							...
							'site_title_description'	=> 'Default site title & description',
							'custom_text'				=> 'Custom logo text'),
                        'default' => 'image',
                    ),
					array(
                        'id' => 'hidden_uploader',
					...
					array(
                        ...
                        'options' => array("excerpt" => "Excerpt", "readmore" => "Full post"),
                        'default' => 'readmore'
                    ),
			...
			$this->sections[] = array(
                ...
                'fields' => array(			
					...
					array(
                        ...
                        'type' => 'media',
                        'url' => true,
                        'title' => __('Custom favicon', 'wpgumby'),
                        'compiler' => 'true',
                        'subtitle' => __("Upload a 16px x 16px PNG/GIF image that will represent your website's favicon.", "wpgumby")
                    ),
					array(
                        'id' => 'width_radio',
                        'type' => 'radio',
                        'title' => __('Choose layout width', 'wpgumby'),
                        'options' => array("fixed" => "Fixed (960px)", "full_width" => "Full width (100%)"),
                        'default' => 'fixed'
                    ),
					array(
                        'id' => 'social_fp',
					...
					array(
                        ...
                        'options' => array("footer" => "Footer", "sidebar" => "Sidebar"),
                        'default' => 'footer'
                    ),
				),
            );			
			...
			$this->sections[] = array(
                ...
                'fields' => array(	
					...
					array(
                        ...
                        'options' => array("zoom" => "Resize to fit (no cropping)", "crop" => "Crop"),
                        'default' => 'zoom'
                    ),
					array(
                        'id' => 'cta_text',
